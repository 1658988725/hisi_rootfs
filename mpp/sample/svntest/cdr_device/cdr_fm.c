...
int cdr_set_qn8027_freq(int iFreq)
{
    ...
    sprintf(ucCmd,"i2c_write 0x02 0x58 0x01 0x%02X",QN8027_Send[0x02]);
	cdr_system(ucCmd);
	
    sprintf(ucCmd,"i2c_write 0x02 0x58 0x00 0x%02X",QN8027_Send[0x01]);//设置为发射模式，寄存器 00H 的 bit5 设置为 1。
    cdr_system(ucCmd);
