...
int cdr_wifi_factory(void)
{
    ...
    if(strcmp("0",(char*)g_sWifiCfgNumber.ucWifiMode) != 0x00) return -1;
	...
	sprintf(cSedApSsidCmd,"sed -i '/EncrypType/ aiwpriv wlan0 set SSID=\"%s\"' /home/wifi/init_wifi_ap_7601.sh",chWifiName);
