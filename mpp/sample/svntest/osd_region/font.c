...
int OSD_Rgb1555_8x16(int nIWidth, int nIHeight, const char *chpStrData, unsigned short* uspPicData)
{
	int nICharIndex;
...
int OSD_Rgb1555_16x24(int nIWidth, int nIHeight,const char *chpStrData, unsigned short* uspPicData)
{
	int nICharIndex;
	unsigned char *ucpCharData;
	unsigned short *uspDst;	
...
int OSD_Rgb1555_16x32(int nIWidth, int nIHeight,const char *chpStrData, unsigned short* uspPicData)
{
	int nICharIndex;
	unsigned char *ucpCharData;
	unsigned short *uspDst;	
...
int OSD_Rgb1555_24x48(int nIWidth, int nIHeight,const char *chpStrData, unsigned short* uspPicData)
{
	int nICharIndex;
	unsigned char *ucpCharData;
	unsigned short *uspDst;	
